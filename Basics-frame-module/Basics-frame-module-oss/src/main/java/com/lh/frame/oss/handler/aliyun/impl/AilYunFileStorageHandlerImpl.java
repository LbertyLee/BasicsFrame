package com.lh.frame.oss.handler.aliyun.impl;
...
import com.lh.frame.oss.handler.aliyun.properties.OssAliyunConfigProperties;
 ...
 */
@Slf4j
//@Service("AilYunFileStorageHandler")
@EnableConfigurationProperties(OssAliyunConfigProperties.class)
public class AilYunFileStorageHandlerImpl extends AbsFileStorageHandler implements FileStorageHandler {
